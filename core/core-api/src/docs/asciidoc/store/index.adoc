...
가게 API는 상품을 등록하고 조회하는 기능을 제공합니다.
...
include::{snippets}/가게 등록/curl-request.adoc[]

=== Http Request

include::{snippets}/가게 등록/http-request.adoc[]

=== Http Response

include::{snippets}/가게 등록/http-response.adoc[]

=== Response Fields

include::{snippets}/가게 등록/response-fields.adoc[]
...
include::{snippets}/가게 상세 조회/curl-request.adoc[]

==== Http Request

include::{snippets}/가게 상세 조회/http-request.adoc[]

==== Http Response

include::{snippets}/가게 상세 조회/http-response.adoc[]
